...
export function PartnersMarquee() {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div
        className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-secondary to-transparent"
      ></div>
      <div
        className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-secondary to-transparent"
      ></div>
    </div>
  );
}
